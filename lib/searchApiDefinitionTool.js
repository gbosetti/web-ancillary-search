...
SearchApiDefinitionTool.prototype.createResultTemplate = function(evt) { 
	...
	//function(){ui.sidebarWorker.port.emit("createCTemplate")}
	var me = this;
	this.onceInSidebar(function(){

		me.sidebarWorker.port.emit("createResultTemplate", {
			locale: me.getJSONLocalizedBundle(),
			thumbnail: me.createResultThumbnail(me.triggerNode, "search-apis-highlighted-element")
		});
	});
}
