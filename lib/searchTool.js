...
SearchTool.prototype.getTumblrService = function() {
	...
	return {
		...
		trigger:'//div[@class="popover_menu_item"]/div/a[1]',
		results: {
			name: 'Posts',
...
SearchTool.prototype.getDBLPApi = function() {
	...
	return {
		...
		keywords:'',
		loadingResStrategy: "WriteAndReload", 
		contentScriptWhen: "ready",
...
SearchTool.prototype.getVKService = function() {
	...
	return {
		name:'VK',
		url:'https://vk.com/search?c%5Bq%5D=x&c%5Bsection%5D=auto',
		keywords:'',
		loadingResStrategy: "WriteAndReload", 
		contentScriptWhen: "ready",
		entry:'//input[@id="ts_input"]',
		trigger:'//a[@id="ts_search_link"]',
		results: {
			name: 'Music',
