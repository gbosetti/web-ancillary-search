...
SearchTool.prototype.getDataForVisualization = function(iframe, callback){
	...
	me.pageWorker.port.on("notifyDomForResultsExtraction", function(data){
		...
		me.logAction("[07][start] Parsing the DOM");
		...
		me.logAction("[08][end] Parsing the DOM");
		me.logAction("[09][start] Extracting results");
		var data = {
		...
		me.logAction("[10][end] Extracting results");
		me.logAction("[11][start] Visualizing results");
		callback(data);
		me.hideLoadingMessage(iframe);
		me.logAction("[12][end] Visualizing results");
	...
	var executingSearch = function(){
		...
		me.pageWorker.port.emit("searchNewInstances", {
			...
			strategy: me.currentApiCog.strategy
		});
...
SearchTool.prototype.getGoogleBooksApi = function() {
	...
	return {
		...
		keywords:'',
		strategy: "WriteAndClickForAjaxCall", 
...
SearchTool.prototype.getGoodreadsApi = function() {
	...
	return {
		...
		keywords:'Ficciones',
		strategy: "WriteAndClickToReload", 
...
XPathSelectorEngine.prototype.getElement = function(aNode, aExpr) {
    ...
    console.log("for xpath management: ", aNode);
