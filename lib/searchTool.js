...
SearchTool.prototype.getInstagramService = function() {
	...
	return {
		...
		contentScriptWhen: "ready",
		entry:'//nav//input',
		trigger: '//section/nav/div/div/div/div[2]//a[contains(@href, "/explore/tags/")]',
		results: {
			name: 'Pictures',
...
SearchTool.prototype.getMicrosoftService = function() {
	...
	return {
		...
		results: {
			name: 'Songs',
			xpath:'//div[@id="nav-songs"]/div/div/table/tbody/tr',
			properties:[
				{
					name:'Name',
					xpath:'//td[3]/a', 
