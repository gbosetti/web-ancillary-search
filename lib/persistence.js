...
function Persistence(locale) {
    ...
    this.file = FileUtils.getFile("ProfD", ["jetpack", "ways@lifia.info.unlp.edu.ar", "ways.sqlite"]);
    ...
    this.initDatabase = function() {
        ...
        //////// DOM ELEMENTS ////////
        dbConn.executeSimpleSQL("CREATE TABLE IF NOT EXISTS 'DomElement' ( " +
            "'id'    INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, " +
            "'xpath' TEXT NOT NULL " +
        ");");

           //////// SOME OF THEM ARE COMPONENTS OF ANOTHER RESULT ////////
            dbConn.executeSimpleSQL("CREATE TABLE IF NOT EXISTS 'ResultToDomElement' ( " +
                "'ownerId'   INTEGER NOT NULL, " +
                "'leafId'    INTEGER NOT NULL, " +
                "PRIMARY KEY(ownerId,leafId) " +
            ");");

            //////// SOME OF THEM ARE RESULTS ////////
            dbConn.executeSimpleSQL("CREATE TABLE IF NOT EXISTS 'Result' (" +
                "'id' INTEGER NOT NULL PRIMARY KEY, " +
                "'engine_id' TEXT NOT NULL " +
            ");");
            dbConn.executeSimpleSQL("CREATE TABLE IF NOT EXISTS 'ResultProperty' (" +
                "'id' INTEGER NOT NULL PRIMARY KEY, " +
                "'key' TEXT NOT NULL, " +
                "'value' TEXT NOT NULL " +
           ");");

            //////// SOME OF THEM ARE SEARCH ENGINE ELEMS (INPUT, TRIGGER, NAV) ////////
            dbConn.executeSimpleSQL("CREATE TABLE IF NOT EXISTS 'SearchEngineElement' ( " +
                "'id' INTEGER NOT NULL PRIMARY KEY, " +
                "'engine_id' TEXT NOT NULL, " +
                "'name' TEXT NOT NULL " +
            ");");
    ...
    this.saveSearchElement = function(data) {

    };
    // +++++++++++++++++++++++++++++++++++++++++
    // +++++++++++ MATERIALIZABLE ++++++++++++++
    // +++++++++++++++++++++++++++++++++++++++++
    /*this.createDomElement = function(data){

        var dbConn = this.openDatabase();
            var statement = dbConn.createStatement("INSERT INTO 'DomElement'  \
                ('xpath')  \
                VALUES (:xpath)");
    ...
    this.createCTemplate = function(jsonData){
        ...
        this.createDomElement(JSON.parse(jsonData));
